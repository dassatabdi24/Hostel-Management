		...
		<div class="card">
			...
			<div class="card-body">
				<form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
					...
					<div class="form-group row">
						<label for="nok" class="col-md-4 col-form-label text-md-right">{{ __("Guardian's Name") }}</label>
					...
					<div class="form-group row">
						<label for="nokno" class="col-md-4 col-form-label text-md-right">{{ __("Guardian's Phone Number") }}</label>
					...
					<div class="row form-group">
						...
						<label for="passport" class="col-md-4 col-form-label text-md-right">{{ __("Photo") }}</label>
