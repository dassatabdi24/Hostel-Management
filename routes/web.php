...
Route::prefix('admin')->group(function(){
	...
	Route::get('/notifications', 'ReportController@index')->name('admin.notifyindex');
	...
	Route::delete('/UDelete/{id}', 'AdminStudentController@uDelete')->name('admin.udelete');
	...
	//reports
	Route::get('/report', 'AdminStudentController@notifyIndex')->name('report.index');
