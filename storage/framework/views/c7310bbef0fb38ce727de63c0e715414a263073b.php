<nav class="navbar navbar-expand-md navbar-light navbar-laravel mb-4">
	<div class="container">
		<a class="navbar-brand" href="<?php echo e(route('admin.dashboard')); ?>">Home</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav mr-auto">
				<li class="nav-item ">
					<a class="nav-link" href="<?php echo e(route('hostels.index')); ?>">Hostels</a>
				</li>
				<li class="nav-item ">
					<a class="nav-link" href="<?php echo e(route('adminmsg.index')); ?>">Messages</a>
				</li>
				<li class="nav-item ">
					<a class="nav-link" href="<?php echo e(route('report.index')); ?>">Stats &amp; Reports</a>
				</li>
				<li class="nav-item ">
					<a class="nav-link" href="<?php echo e(route('admin.admins')); ?>">Provosts and Staff</a>
				</li>
				<li class="nav-item ">
					<a class="nav-link" href="<?php echo e(route('admin.notifyindex')); ?>">Notifications</a>
				</li>
			</ul>
...
<script>
	$(function(){
		...
		let url = "<?php echo e(route('admin.student.search')); ?>";
